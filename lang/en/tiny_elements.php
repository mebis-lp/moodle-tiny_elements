...
$string['whatif'] = 'Simulate import';
$string['whatif_help'] = 'If checked, this will simulate an import run without changing anything. This can be used to see if there are any changes affecting existing items.';
