...
/**
 * Webservice to duplicate tiny_elements items.
 *
 ...
 */
class duplicate_item extends external_api {
    /**
    ...
    public static function execute(int $id, string $table): array {
        ...
        switch ($table) {
            case 'compcat':
                $manager->duplicate_compcat($id);
                break;
            case 'flavor':
                $manager->duplicate_flavor($id);
                break;
            case 'variant':
                $manager->duplicate_variant($id);
                break;
            case 'component':
                $manager->duplicate_component($id);
                break;
        }
    ...
    public static function execute_returns() {
        return new external_single_structure([
            'result' => new external_value(PARAM_BOOL, 'Duplicated successfully.'),
        ]);
    }
}
